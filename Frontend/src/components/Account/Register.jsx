...
export default function Register({ onSwitchToSignIn }) {
    ...
    return (
        <div className="w-full max-w-3xl bg-white/10 px-8 py-4 rounded-3xl shadow-xl max-h-[95vh] overflow-y-auto">
            ...
            </div>
            {
                loading ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <div className="relative mt-3">
                                    <input
                                        className="w-full rounded-xl border border-gray-600 bg-gray-900 px-5 py-4 text-lg md:text-xl text-white focus:ring-2 focus:ring-purple-500 outline-none"
                        ...
                        <button
                            type="submit"
                            className="w-full flex items-center justify-center rounded-2xl cursor-pointer bg-purple-500 px-6 py-5 text-xl md:text-2xl font-bold text-white transition-all duration-300 hover:bg-purple-600 hover:shadow-xl"
                        >
