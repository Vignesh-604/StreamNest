            ...
            </div>
            {
                loading ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <button
                            type="submit"
                            className="w-full flex items-center justify-center rounded-2xl bg-purple-500 px-6 py-5 text-xl md:text-2xl font-bold text-white transition-all duration-300 hover:bg-purple-600 hover:shadow-xl"
                        >
