...
export function Sidebar() {
  ...
  return (
    <aside className={`fixed h-screen transition-width duration-300 ${isCollapsed ? 'w-16' : 'w-64'} flex-col overflow-y-auto border-r bg-black px-5 py-8`}>
      ...
      <div className="mt-6 flex flex-1 flex-col justify-between">
        <nav className={`-mx-3 space-y-6 ${isCollapsed ? 'hidden' : 'block'}`}>
