...
export default function Playlists({ user = "" }) {
    ...
    const userId = user === "" ? (JSON.parse(Cookies.get("user")))._id : user
    ...
    return (
        <div className="flex flex-col place-items-center px-4 min-w-[36rem]">
            ...
            <form className="flex flex-row my-6 border-white text-lg" onSubmit={() => newPlaylist()}>
                <h1 className="w-full my-auto font-semibold">
                    Create new playlist: 
                </h1>
                <input
                    className="flex mx-1 h-10 w-full rounded-md border border-black/30 bg-transparent p-1 text-lg placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                    type="text" required
                ...
                />
                <input
                    className="flex mx-1 h-10 w-full rounded-md border border-black/30 bg-transparent px-1 py-1 text-lg placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                    type="text" required
